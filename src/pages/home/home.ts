...
import { NavController, Platform, Slides, Events, FabContainer, Content, LoadingController } from 'ionic-angular';
...
export class HomePage {
    ...
    //
    homeSongList : Array<any> = new Array(0);
    ...
    redirectionPage(pageName:String,fab: FabContainer) {
         ...
         if(pageName==="facebook") {
            url = "https://www.facebook.com/songlyricsintamil/?_rdc=1&_rdr";
         }
         if(pageName==="twitter") {
            url = "https://twitter.com/LyricsinTamil";
         }
         if(pageName==="googleplus") {
            url = "https://plus.google.com/+Lyricsintamil2014";
         }
         if(pageName==="youtube") {
            url = "https://www.youtube.com/channel/UCSQU7zE6O0AnB_VYja_i_pg";
         }
    ...
    //    (<HTMLElement>document.querySelector('#contentslider .swiper-wrapper')).style.height = (this.homeSliderPage * 10 * homeSliderHeight + 500) + "px"
    }
